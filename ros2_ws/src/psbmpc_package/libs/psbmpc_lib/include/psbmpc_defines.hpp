...
#define MAX_N_PS 12                     // Max number of prediction scenarios allowable for obstacle trajectory matrices on the device
...
#define MAX_N_POLYGONS 12               // Max number of static obstacles/polygons allowable on the device
#define MAX_N_VERTICES 4000             // Max number of vertices in a polygon allowable on the device
