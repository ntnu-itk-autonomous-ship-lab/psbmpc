...
#define MAX_N_OBST 2                    // Max number of obstacles allowable on the device
#define MAX_N_PS 201                    // Max number of prediction scenarios allowable for obstacle trajectory matrices on the device
...
#define MAX_N_POLYGONS 6                // Max number of static obstacles/polygons allowable on the device
