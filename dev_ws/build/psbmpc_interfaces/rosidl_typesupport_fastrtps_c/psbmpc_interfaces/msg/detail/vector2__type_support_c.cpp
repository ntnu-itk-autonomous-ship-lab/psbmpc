...
#include "psbmpc_interfaces/msg/detail/vector2__rosidl_typesupport_fastrtps_c.h"
...
using _Vector2__ros_msg_type = psbmpc_interfaces__msg__Vector2;
...
static uint32_t _Vector2__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_psbmpc_interfaces__msg__Vector2(
...
{
  return max_serialized_size_psbmpc_interfaces__msg__Vector2(
    full_bounded, 0);
}
