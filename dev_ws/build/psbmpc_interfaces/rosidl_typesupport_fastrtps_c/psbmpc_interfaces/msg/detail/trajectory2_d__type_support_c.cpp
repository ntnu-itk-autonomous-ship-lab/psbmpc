...
#include "psbmpc_interfaces/msg/detail/trajectory2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "psbmpc_interfaces/msg/detail/vector2__functions.h"  // waypoints
...
using _Trajectory2D__ros_msg_type = psbmpc_interfaces__msg__Trajectory2D;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      psbmpc_interfaces__msg__Vector2__Sequence__fini(&ros_message->waypoints);
    }
...
size_t get_serialized_size_psbmpc_interfaces__msg__Trajectory2D(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectory2D__ros_msg_type * ros_message = static_cast<const _Trajectory2D__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Trajectory2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_psbmpc_interfaces__msg__Trajectory2D(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_psbmpc_interfaces
size_t max_serialized_size_psbmpc_interfaces__msg__Trajectory2D(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_psbmpc_interfaces__msg__Trajectory2D(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, psbmpc_interfaces, msg, Trajectory2D)() {
