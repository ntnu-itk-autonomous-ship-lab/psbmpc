...
#include "psbmpc_interfaces/msg/detail/offset__rosidl_typesupport_fastrtps_c.h"
...
using _Offset__ros_msg_type = psbmpc_interfaces__msg__Offset;
...
size_t get_serialized_size_psbmpc_interfaces__msg__Offset(
  const void * untyped_ros_message,
...
static uint32_t _Offset__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_psbmpc_interfaces__msg__Offset(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_psbmpc_interfaces
size_t max_serialized_size_psbmpc_interfaces__msg__Offset(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_psbmpc_interfaces__msg__Offset(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, psbmpc_interfaces, msg, Offset)() {
