...
#include "psbmpc_interfaces/msg/detail/trajectory2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const psbmpc_interfaces::msg::Trajectory2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<psbmpc_interfaces::msg::Trajectory2D *>(
    untyped_ros_message);
...
{
  return &psbmpc_interfaces::msg::typesupport_fastrtps_cpp::_Trajectory2D__handle;
}
