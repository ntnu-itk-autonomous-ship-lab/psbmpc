    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'psbmpc_interfaces.msg.Trajectory2D')
            logger.debug(
...
class Trajectory2D(metaclass=Metaclass_Trajectory2D):
    ...
    _fields_and_field_types = {
        ...
        'waypoints': 'sequence<psbmpc_interfaces/Vector2>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['psbmpc_interfaces', 'msg'], 'Vector2')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'waypoints' field must be a set or sequence and each value of type 'Vector2'"
