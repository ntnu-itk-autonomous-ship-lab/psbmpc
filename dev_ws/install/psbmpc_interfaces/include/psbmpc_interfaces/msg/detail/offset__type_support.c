...
#include <stddef.h>
#include "psbmpc_interfaces/msg/detail/offset__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  psbmpc_interfaces__msg__Offset__init(message_memory);
}

void Offset__rosidl_typesupport_introspection_c__Offset_fini_function(void * message_memory)
{
  psbmpc_interfaces__msg__Offset__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Offset__rosidl_typesupport_introspection_c__Offset_message_member_array[2] = {
  {
    ...
    offsetof(psbmpc_interfaces__msg__Offset, u_m),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(psbmpc_interfaces__msg__Offset, chi_m),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Offset__rosidl_typesupport_introspection_c__Offset_message_members = {
  ...
  "Offset",  // message name
  2,  // number of fields
  sizeof(psbmpc_interfaces__msg__Offset),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, psbmpc_interfaces, msg, Offset)() {
