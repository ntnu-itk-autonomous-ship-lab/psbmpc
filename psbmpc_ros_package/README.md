# thecolavrepo
This repository contains branches of different Collision Avoidance (COLAV) algorithms, mainly based on the Scenario-based Model Predictive Control Algorithm [[1]](#1).
