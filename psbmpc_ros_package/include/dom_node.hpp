...
private:
  ...
  //=======================================================
  std::mutex ownship_data_mutex, do_estimate_data_mutex, track_data_mutex,
      polygons_data_mutex, psbmpc_mode_data_mutex;
...
public:
  ...
  void do_estimate_callback(
      const ros_af_msgs::DynamicObstacleEstimate::ConstPtr &msg);
