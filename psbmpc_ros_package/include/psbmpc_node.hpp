/****************************************************************************************
 *
 *  File name : psbmpc_node.hpp
 *
 *  Function  : Header file for the PSBMPC ROS node.
 *
 *
 *	           ---------------------
 *
...
private:
	...
	std::mutex ownship_data_mutex, obstacles_data_mutex, polygons_data_mutex,
		wp_data_mutex, wind_data_mutex, supervisor_mode_data_mutex, psbmpc_mode_data_mutex;
...
public:
	...
	{
		std::scoped_lock supervisor_mode_lock(supervisor_mode_data_mutex, psbmpc_mode_data_mutex);
	...
	bool set_psbmpc_mode_handler(psbmpc::SetPSBMPCMode::Request &req, psbmpc::SetPSBMPCMode::Response &res)
	{
	...
	bool load_waypoints_handler(psbmpc::LoadWaypoints::Request &req, psbmpc::LoadWaypoints::Response &res);
};