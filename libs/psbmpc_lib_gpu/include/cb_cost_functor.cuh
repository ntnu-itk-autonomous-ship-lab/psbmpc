...
private: 
	...
	__device__ inline void calculate_collision_probabilities(TML::PDMatrix<double, MAX_N_PS, MAX_N_SAMPLES> &P_c_i, const int i, const unsigned int cb_index);
	...
	__device__ inline double calculate_control_deviation_cost(const TML::PDMatrix<double, 2 * MAX_N_M, 1> &offset_sequence, const unsigned int cb_index);
	...
	//
	__device__ double calculate_chattering_cost(const TML::PDMatrix<double, 2 * MAX_N_M, 1> &offset_sequence, const unsigned int cb_index);
