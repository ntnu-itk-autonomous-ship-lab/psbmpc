...
public:
	...
	__device__ bool get_ps_COLREGS_violation_indicator(const int ps_index) const { return mu[ps_index]; }
	...
	__device__ Eigen::MatrixXd get_ps_trajectory(const int ps_index) const { return xs_p[ps_index]; };
