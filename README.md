...
This repository contains C++ implementations for the Scenario-based Model Predictive Control Algorithm (SB-MPC) [[1]](#1) and its probabilistic variant (PSB-MPC) described in <https://ieeexplore.ieee.org/abstract/document/10876006/>, originating from research as part of the NTNU Centre for Autonomous Marine Operations and Systems (AMOS).
