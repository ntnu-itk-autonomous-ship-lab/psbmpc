...
#include "Vector2.h"
	...
	private:
		 ...
		 */
		static const std::size_t MAX_LEAF_SIZE = 10; //*** enough?
		...
		*/
		...
		Agent *const agent_; // was Simulator *const simulator_;
		std::vector<std::size_t> obstacles_; //was agents_
