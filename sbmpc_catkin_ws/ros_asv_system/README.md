...
The simulator is extended to include a simulation based mpc controller by 
Inger Berge Hagen and Giorgio Kufoalor.
This extension includes a dynamic reciprocal velocity obstacles method by 
Giorgio Kufoalor.
...
collision avoidance.
+ `asv_ctrl_sb_mpc` : an implementation of a simulation based model predictive control
algorithm for collision avoidance.
+ `asv_ctrl_drvo` : an implementation of the dynamic reciprocal velocity obstacles algorithm 
