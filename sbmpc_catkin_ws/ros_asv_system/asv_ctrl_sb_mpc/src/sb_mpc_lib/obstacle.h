...
class obstacle
{
	...
	/// Constructor
	obstacle(const Eigen::Matrix<double,10,1>& state, double T, double dt, const Eigen::Matrix<double,-1,1>& chi_os, const Eigen::Matrix<double,-1,1>& u_os, int obst_filter_on); //9->10
