...
private:
    ...
    static constexpr double colregs_distance = 1000;
    static constexpr double colregs_start_time = 800;
    static constexpr double head_on_width = 10 * DEG2RAD;
    static constexpr double overtaking_angle = (90 + 22.5) * DEG2RAD;
    static constexpr double max_acceptable_SO_speed_change = 2;
    static constexpr double max_acceptable_SO_course_change = 2.5 * DEG2RAD;
    static constexpr double critical_distance_to_ignore_SO = 0;
    ...
    SpeedChange evaluate_speed_change(const Eigen::MatrixXd &ownship_trajectory) const
    {
        ...
        {
            if (ownship_trajectory(SOG, i) - initial_ownship_state.value()(SOG) > max_acceptable_SO_speed_change)
