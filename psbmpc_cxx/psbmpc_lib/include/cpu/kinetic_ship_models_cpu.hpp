...
public:
  ...
  void update_ctrl_input(const double u_d, const double psi_d,
                         const Eigen::Matrix<double, 6, 1> &xs);

  Eigen::Matrix<double, 6, 1>
  predict(const Eigen::Matrix<double, 6, 1> &xs_old, const double dt,
  ...
  Eigen::Matrix<double, 6, 1>
  predict(const Eigen::Matrix<double, 6, 1> &xs_old, const double u_d,
