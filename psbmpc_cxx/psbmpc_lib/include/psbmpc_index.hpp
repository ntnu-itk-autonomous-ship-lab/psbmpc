...
#define N_DPAR 21 // Number of double type parameters in PSBMPC
...
#define i_dpar_kappa_SO 8  // COLREGS stand-on (SO) penalty parameter
#define i_dpar_kappa_GW 9  // COLREGS give-way (GW) penalty parameter
#define i_dpar_kappa_RA 10 // COLREGS readily apparent (RA) penalty parameter

#define i_dpar_K_u 11    // Speed change penalty parameter from the current speed reference
#define i_dpar_K_du 12   // Penalty parameter for speed change between current and previous speed modification
#define i_dpar_K_chi 13  // Course modification penalty parameter
#define i_dpar_K_dchi 14 // Penalty parameter for course change between current and previous course modification
#define i_dpar_K_e 15    // Penalty parameter for large predicted cross track error

#define i_dpar_G_1 16 // Grounding cost penalty parameter
#define i_dpar_G_2 17 // Grounding cost penalty parameter connected to non-zero wind speed
#define i_dpar_G_3 18 // Grounding cost distance discount parameter
#define i_dpar_G_4 19 // Grounding cost time discount parameter

#define i_dpar_epsilon_rdp 20 // Ramer-Douglas-Peucker distance threshold parameter
