...
#define i_ipar_p_step_do 2        // Step between state samples in dynamic obstacle cost eval, used for faster cost eval.
#define i_ipar_p_step_grounding 3 // Step between state samples in static obstacle cost eval, used for faster cost eval.
...
#define i_dpar_T_track_loss_threshold 3 // Time threshold for considering a target ship to be lost

#define i_dpar_d_safe 4        // Own-ship safety zone radius
#define i_dpar_d_do_relevant 5 // Range for considering dynamic obstacles in the MPC
#define i_dpar_d_so_relevant 6 // Range for considering static ostacles in the MPC
...
#define i_dpar_K_u 12    // Speed change penalty parameter from the current speed reference
#define i_dpar_K_du 13   // Penalty parameter for speed change between current and previous speed modification
#define i_dpar_K_chi 14  // Course modification penalty parameter
#define i_dpar_K_dchi 15 // Penalty parameter for course change between current and previous course modification
