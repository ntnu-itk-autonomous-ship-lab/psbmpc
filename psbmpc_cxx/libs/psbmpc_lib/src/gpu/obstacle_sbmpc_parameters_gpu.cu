/****************************************************************************************
*
*  File name : obstacle_sbmpc_parameters_gpu.cu
*
*  Function  : Class function file for the Obstacle SB-MPC parameter class used on the GPU
*
*  
*	           ---------------------
*
...
#include "gpu/obstacle_sbmpc_parameters_gpu.cuh"
