/****************************************************************************************
*
*  File name : ownship_gpu.cuh
*
*  Function  : Header file for the GPU used ownship class. Modified and extended version 
*			   of the "Ship_Model" class created for SBMPC by Inger Berge Hagen and 
*			   Giorgio D.  Kwame Minde Kufoalor through the Autosea project. Facilitates 
*			   Guidance, Navigation and Control (GNC) of a surface vessel. Uses mainly
*  			   TML for matrix functionality.
*  
*	           ---------------------
*
*  Version 1.0
