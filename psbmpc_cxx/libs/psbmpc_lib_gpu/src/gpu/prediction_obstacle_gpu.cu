/****************************************************************************************
*
*  File name : prediction_obstacle_gpu.cu
*
*  Function  : Class functions for the GPU used predicted obstacle class in the PSB-MPC.
	...
	x_offset(xs_aug(4) - xs_aug(5)), y_offset(xs_aug(7) - xs_aug(6))
{
	...
	float psi = atan2(xs_aug(3), xs_aug(2));
