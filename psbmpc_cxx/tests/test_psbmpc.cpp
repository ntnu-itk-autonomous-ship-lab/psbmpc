...
int main()
{
	...
	PSBMPC_LIB::CPU::Ownship ownship(ownship_length, w, T_chi, T_U, R_a, LOS_LD, LOS_K_i);
	...
	PSBMPC_LIB::CPU::Ownship obstacle_sim(ownship_length, w, T_chi, T_U, R_a, LOS_LD, LOS_K_i);
